...
Vehicle.prototype.beep = function() { if(this.isRunning) return "beep"; }

var car = new Vehicle("mazda", "3", 1987);
car.turnOn();
...
Person.prototype.addToFamily = function (person) {
    if(person instanceof Person && !this.family.includes(person)) this.family.push(person);
...
String.prototype.reverse = function() {
    // store a copy of the string first
    var newStr = "";
